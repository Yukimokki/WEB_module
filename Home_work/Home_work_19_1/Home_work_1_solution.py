    ...
    <div class="container">
        ...
        <main class="row">
            <div class="row text-center">
                ...
                <main class="row">
                    <div class="row text-center">
                        <div class="card ms-2 rounded-3 col-12" >
                                ...
                                <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
                                    ...
                                    <div class="collapse" id="collapseExample1">
                                        <div class="card card-body">
                                            Купить можно в магазине или онлайн, или через колл-центр или оставив форму для связи
                                        </div>
                                    </div>
                                    <div class="collapse" id="collapseExample2">
                                        <div class="card card-body">
                                            Доставка осуществляется онлайн, код доступа поступит на указанный электронный адрес
                                        </div>
                                    </div>
                                    <div class="collapse" id="collapseExample3">
                                        <div class="card card-body">
                                            Зуб даю, все будет как в аптеке
                                        </div>
                                    </div>
                            </div>
                        </div>
